 ...
 */
public typealias JoyStickViewMonitor = (_ angle: Float, _ displacement: Float) -> ()
public typealias JoyStickViewCompletion = () -> ()
...
public final class JoyStickView: UIView {
    ...
    public var onUpdate: JoyStickViewMonitor? = nil
    public var onComplete: JoyStickViewCompletion? = nil
    ...
    private func updateLocation(location: CGPoint) {
        ...
        if newClampedDisplacement != displacement || newAngleRadians != lastAngleRadians {
            ...
            onUpdate?(angle.toFloat(), displacement.toFloat())
        }
    }
}
